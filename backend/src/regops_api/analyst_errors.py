...
class AnalystCode(StrEnum):
    ...
    MODEL_ARMOR_OUTPUT_SENSITIVE_DATA_BLOCKED = "MODEL_ARMOR_OUTPUT_SENSITIVE_DATA_BLOCKED"
    MODEL_ARMOR_OUTPUT_UNSAFE_CONTENT_BLOCKED = "MODEL_ARMOR_OUTPUT_UNSAFE_CONTENT_BLOCKED"
